var texts = ["Привет)", "Пожалуй начнем", "Меня зовут Шамиль", "мне 22 года или лет, как тебе удобнее", "сейчас учусь на инженера геодезиста в высшем учебном заведение", "эту хрень которую ты читаешь я сделал сам", "то есть сделал его полностью", "учеба в высшем заведение мне нравится но я знаю, что это не мое ", "свое я уже нашел, и было бы прикольно", "если бы я сказал, что это ты", "но не будем, это программирование)"
