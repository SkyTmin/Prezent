...
"надеюсь, что ты улыбнулась", "кароче, я парень не простой", "со мной точно не соскучишься","пожалуй, мы заканчим на этой ноте", "было не скучно, верно?)", "Думаю не скучно", "выбор за тобой", ]; // массив с текстами
